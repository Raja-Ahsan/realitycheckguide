...
<section class="content-header">
    <h1 style="color:#c98900 !important; font-weight: 700;">Create Job Post</h1>
</section>
        ...
        <div class="col-md-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Create New Job Post</h3>
                </div>
                <form method="POST" action="{{ route('user.store-job-post') }}">
                    @csrf
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" id="description" name="description" rows="6" placeholder="Describe the job requirements, scope of work, and any specific details..." required>{{ old('description') }}</textarea>
                            @error('description')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary">
                            <i class="fa fa-save"></i> Create Job Post
                        </button>
