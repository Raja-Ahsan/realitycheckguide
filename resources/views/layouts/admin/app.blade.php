...
<head>
	...
	<style>
		...
		.skin-blue .main-header .navbar,
		.skin-blue .main-sidebar {
			background-image: url('{{ asset('public/admin/assets/images/page/bg-2.png') }}') !important;
		...
		.info-box {
			...
			width: 100% !important;
			box-shadow: 5px 5px 20px 0px rgb(86 86 86 / 43%) !important;
		...
		.info-box:hover {
			background-image: linear-gradient(to right, rgb(255 255 255), rgb(171 171 171)) !important;
			color: #fff !important;
		}
	...
	/* 	a.active {
		...
		a.btn.btn-primary.btn-sm:hover {
			background-color: #017178 !important;
		}
		...
		.nav-tabs-custom>.nav-tabs>li.active {
			border-top-color: #017178 !important;
		}
