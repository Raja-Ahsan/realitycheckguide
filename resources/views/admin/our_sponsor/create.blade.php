...
<section class="content-header">
	<div class="content-header-left">
		<h1>Add Our Location</h1>
	</div>
	<div class="content-header-right">
		<a href="{{ route('our_sponsor.index') }}" class="btn btn-primary btn-sm">View All</a>
	</div>
</section>
...
<section class="content">
	<div class="row">
		<div class="col-md-12">
			<form action="{{ route('our_sponsor.store') }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
				@csrf
