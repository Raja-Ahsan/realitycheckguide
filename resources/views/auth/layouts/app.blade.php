...
<head>
    ...
    <style>
        /* .login-page {
            background: linear-gradient(135deg, #1e67a8, #00c6ff);
        } */


        .login-page {
            position: relative;
            background: linear-gradient(1deg, #6e6e6e, #cc8a00, #cc8a00, #0670bb, #022555);
            background-size: 400% 400%;
            animation: rotateGradient360 10s linear infinite;
