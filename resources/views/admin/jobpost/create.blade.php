				...
				<div class="box box-info">
					<div class="box-body">
                            ...
                            <div class="col-sm-9">
                                <select name="job_category_id" id="job_category_id" class="form-control" required>
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}" {{ old('job_category_id')==$category->id?'selected':'' }}>{{ $category->title }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-9">
                                <input type="text" autocomplete="off" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Job Title" required>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-9">
                                <textarea class="form-control texteditor" name="description" id="description" maxlength="200" style="height:140px;" placeholder="Enter Description" required>{{ old('description') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="number" step="0.01" min="0" class="form-control" id="budget_min" name="budget_min" value="{{ old('budget_min') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="number" step="0.01" min="0" class="form-control" id="budget_max" name="budget_max" value="{{ old('budget_max') }}" required>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-4">
								<img style="width: 80px" id="jobpost_preview" src="{{ asset('public/admin/assets/images/default.jpg') }}" alt="Image Not Found ">
							</div>
						</div>
						<div class="form-group">
