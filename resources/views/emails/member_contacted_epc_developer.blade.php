...
<body>
    <div class="email-container">
        <div class="email-header">
            <img src="https://img.icons8.com/clouds/100/000000/handshake.png" alt="Submittal Logo">
        ...
        <div class="email-footer">
            &copy; {{ date('Y') }} Submittal Builder. All rights reserved.<br>
            <span style="font-size:0.9em;">Submittal Builder</span>
        </div>
    </div>
</body>
</html>
