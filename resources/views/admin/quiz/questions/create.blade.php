	...
	<div class="row">
		<div class="col-md-12">
			<div class="box box-info">
				<div class="box-body">
					<form action="{{ route('admin.quiz.questions.store') }}" method="POST" enctype="multipart/form-data">
						@csrf
						...
						<div class="form-group">
							...
							<textarea class="form-control" id="question" name="question" rows="3" placeholder="Enter the question" required>{{ old('question') }}</textarea>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="option_a" name="option_a" value="{{ old('option_a') }}" placeholder="Enter option A" required>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="option_b" name="option_b" value="{{ old('option_b') }}" placeholder="Enter option B" required>
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="option_c" name="option_c" value="{{ old('option_c') }}" placeholder="Enter option C" required>
							...
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="text" class="form-control" id="option_d" name="option_d" value="{{ old('option_d') }}" placeholder="Enter option D" required>
