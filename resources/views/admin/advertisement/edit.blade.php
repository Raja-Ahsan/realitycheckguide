@extends(((Auth::user()->hasRole('Admin')) ? 'layouts.admin.app' : 'layouts.electrician.app'))
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<img style="width: 80px" id="advertisement_preview" src="{{ asset('public/admin/assets/images/advertisement') }}/{{ $advertisements->image }}" alt="Image Not Found ">
							</div>
						</div>
						<div class="form-group">
